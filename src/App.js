...
class App extends Component {
  ...
  drawHeader(){
    ...
    return(
      <div>
        {mobileButtenMenu}
        <header className="panel-cover" style={{background_image: "https://cdn.jsdelivr.net/gh/etjejong/etjejong.github.io/src/images/background.jpg", maxWidth:'100%'}}>
          <div className="panel-main">
            <div className="panel-main__inner panel-inverted">
              <div className="panel-main__content">
                {profilePicButton}
                <h1 className="panel-cover__title panel-title">Jejong Lee</h1>
                <hr className="panel-cover__divider"/>
                <p className="panel-cover__description">영어강사</p>
                <p className="panel-cover__description">(現)중등영어학원 강사</p>
  ...
  drawBody(){
    var footer = <div><footer className="footer">
        <span className="footer__copyright">&copy; 2022. Jejong Lee All rights reserved.</span>
      </footer>
      </div>
